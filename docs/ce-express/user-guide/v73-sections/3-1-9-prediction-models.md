...
- **Frequency (f)** – Higher frequencies tend to attenuate more rapidly over ground. The attenuation rate increases significantly above 3 MHz.
...
- **Surface refractivity, Surface Conductivity (σ) and Relative Permittivity (εᵣ)** – The surface over which the wave propagates critically affects signal strength:
  - Sea water: High conductivity, minimal loss
  - Dry land or desert: Low conductivity, high loss
  - Typical values range from:
    - Conductivity: 10⁻⁴ to 5 S/m
...
| Clutter class | Nominal Distance | Diffraction loss coefficient | Enclosed receiver loss offset | Enclosed receiver loss scaling coefficient | Enclosed receiver loss frequency exponent coefficient | Receiver point loss offset |
|---|---|---|---|---|---|---|
| Open / Terrain | 1 | 1 | 17 | 0.25 | 1 | 0 |
| Grassland | 27 | 0.5 | 0 | 0.82 | 0.65 | 0 |
| Sparse forest | 27 | 0.5 | 0 | 0.82 | 0.65 | 0 |
| Medium dense forest | 27 | 0.5 | 0 | 0.89 | 0.65 | 0 |
| Very dense forest | 15 | 0.5 | 0 | 0.95 | 0.65 | 0 |
| Low density urban (Low buildings) | 27 | 0.5 | 0 | 0.89 | 0.65 | 0 |
| Low density urban (High buildings) | 27 | 0.5 | 0 | 0.89 | 0.65 | 0 |
| Medium density urban (Low buildings) | 15 | 0.6 | 0 | 0.89 | 0.65 | 0 |
| Medium density urban (High buildings) | 15 | 0.6 | 0 | 0.89 | 0.65 | 0 |
| High density urban (Low buildings) | 10 | 0.7 | 0 | 0.89 | 0.65 | 0 |
| High density urban (High buildings) | 10 | 0.7 | 0 | 0.89 | 0.65 | 0 |
| High density urban (Very high buildings) | 10 | 0.7 | 0 | 0.89 | 0.65 | 0 |
| Building blocks | 15 | 0.6 | 0 | 0.89 | 0.65 | 0 |
...
| Inland water | 27 | 0.5 | 0 | 0.89 | 0.65 | 0 |
| Concrete building | 1 | 1 | 5 | 0.25 | 1 | 0 |
| Glass building | 1 | 1 | 2 | 0.25 | 1 | 0 |
| Wood building | 1 | 0.6 | 2 | 0.25 | 1 | 0 |
...
| Clutter class | Enclosed receiver loss offset | Enclosed receiver loss scaling coefficient | Enclosed receiver loss frequency exponent coefficient |
|---|---|---|---|
...
| Clutter class | Surface refractivity | Relative permittivity | Surface conductivity |
|---|---|---|---|
| Open / Terrain | 1 | 1 | 17 |
| Grassland | 27 | 0.5 | 0 |
| Sparse forest | 27 | 0.5 | 0 |
| Medium dense forest | 27 | 0.5 | 0 |
| Very dense forest | 15 | 0.5 | 0 |
| Low density urban (Low buildings) | 27 | 0.5 | 0 |
| Low density urban (High buildings) | 27 | 0.5 | 0 |
| Medium density urban (Low buildings) | 15 | 0.6 | 0 |
| Medium density urban (High buildings) | 15 | 0.6 | 0 |
| High density urban (Low buildings) | 10 | 0.7 | 0 |
| High density urban (High buildings) | 10 | 0.7 | 0 |
| High density urban (Very high buildings) | 10 | 0.7 | 0 |
| Building blocks | 15 | 0.6 | 0 |
...
| Airport | 27 | 0.6 | 0 |
| Sea | 27 | 0.5 | 0 |
| Inland water | 27 | 0.5 | 0 |
| Concrete building | 1 | 1 | 5 |
| Glass building | 1 | 1 | 2 |
| Wood building | 1 | 0.6 | 2 |
