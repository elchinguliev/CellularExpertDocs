...
| Option | Icon |
|---|---|
| Edit statistic | ![icon](../../../assets/images/ce-express/user-guide-v73/p131-img2.png) |
| Delete statistic | ![icon](../../../assets/images/ce-express/user-guide-v73/p131-img3.png) |
...
| Option | Description |
|---|---|
| Download as CSV | Download statistic results as csv file. |
| Publish to Portal | Publish statistic polygons as an ArcGIS layer. The output polygons will have the statistic results assigned to them as attributes. |
...
| Raster layer | The calculation result layer that will be used as the source for statistics item. |
| Band | The color of each segment in the statistics. The color bands are automatically retrieved from the raster layer. |
...
| Point layer (optional) | Workspace 'extra layer' (point feature layer). If selected, the statistics will be calculated not by total polygon area coverage, but by point coverage (% and #) within each polygon. |
