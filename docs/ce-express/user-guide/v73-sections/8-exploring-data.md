...
Selected ![icon](../../../assets/images/ce-express/user-guide-v73/p286-img2.png) button:
...
![icon](../../../assets/images/ce-express/user-guide-v73/p288-img2.png) - Open the Data View Panel

![icon](../../../assets/images/ce-express/user-guide-v73/p288-img3.png) - Go one step back

![icon](../../../assets/images/ce-express/user-guide-v73/p288-img4.png) - Select / unselect all files and folders

![icon](../../../assets/images/ce-express/user-guide-v73/p288-img5.png) - Download selected files

![icon](../../../assets/images/ce-express/user-guide-v73/p289-img1.png) - Delete selected files

![icon](../../../assets/images/ce-express/user-guide-v73/p289-img2.png) - Restore selected files
...
You can restore the image by selecting the strikethrough object and clicking ![icon](../../../assets/images/ce-express/user-guide-v73/p289-img4.png):
