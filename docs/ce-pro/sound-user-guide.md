# CE Desktop Sound User Guide v4.9

Cellular Expert Desktop Sound for [ArcGIS Pro](https://www.google.com/search?q=[ArcGIS](https://www.google.com/search?q=ArcGIS+Esri+[GIS](https://www.google.com/search?q=GIS+Geographic+Information+System)+platform)+Pro+Esri+desktop+software) User Guide 4.9
Table of Contents
...
5.1.3 [Clutter](https://www.google.com/search?q=clutter+land+use+classification+radio+planning) heights 24s
5.1.4 Buildings 28
...
Cellular Expert Desktop Sound for [ArcGIS Pro](https://www.google.com/search?q=ArcGIS+Pro+Esri+desktop+software) User Guide 4.9
...
## 7.7 Template Manager 98

7.7.1 Edit [Network Objects](https://www.google.com/search?q=radio+network+objects+sites+cells+GIS) template 99
7.7.2 Manage [Network Object](https://www.google.com/search?q=radio+network+object+GIS+database) Template 100
7.7.3 Modulations 100
7.7.4 Modulation Editor 102

## 7.8 Import Objects 104

7.8.1 [Import](https://www.google.com/search?q=data+import+GIS+network+objects+[CSV](https://www.google.com/search?q=CSV+comma+separated+values+file+format)) Cells 105
7.8.2 [Import](https://www.google.com/search?q=data+import+GIS+network+objects+[CSV](https://www.google.com/search?q=CSV+comma+separated+values+file+format)) Sites, Radar, [CPE](https://www.google.com/search?q=CPE+Customer+Premises+Equipment+wireless), or Repeaters 108

## 7.9 Import/Export Antenna Files 109

7.9.1 Import Antennas 109
7.9.2 [Export](https://www.google.com/search?q=data+export+GIS+raster+vector) Antennas 109
7.9.3 Create Antennas 110
8. Profile 112

## 8.1 Profile Tool 112

8.1.1 Properties 112
8.1.2 Draw Profile 116
8.1.3 Tools 123
8.1.4 Import 127
8.1.5 [Export](https://www.google.com/search?q=data+export+GIS+raster+vector) (Profile Report) 128
8.1.6 Settings 130
9. [Coverage Prediction](https://www.google.com/search?q=coverage+prediction+RF+radio+planning) 131

## 9.1 CE Calculation Task List 131

## 9.2 Visibility Prediction 131
...
## 10.1 License information 135

## 10.2 Help 135

10.2.1 Documentation 135
10.2.2 What’s New 136
10.2.3 Technical Support 137
10.2.4 Error log 137
11. Technical Support 139
Confidential ©Cellular Expert, 2026 Page | 4

---

Cellular Expert Desktop Sound for ArcGIS Pro User Guide 4.9
