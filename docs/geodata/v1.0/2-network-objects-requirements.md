...
### Import from Organization's Portal
...
| Unique identification | cell_name | [text] | 5G cell XXYY | Represents cell identification, usually name. |
...
**[Antenna pattern](#kw:managing-the-antenna-library:ce-express-antenna) file structure**
