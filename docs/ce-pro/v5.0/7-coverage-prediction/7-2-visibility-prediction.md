...
> **Applies to:** Sound, EMF, Indoor, RCP, RLP.
...
Click the Visibility Prediction button to open the dialog.

![Visibility Prediction dialog with Calculation settings](../../../assets/images/ce-pro/v5.0/visibility-prediction-panel.png)

| Parameter | Description |
|---|---|
| Calculation Name | Name of the calculation that will be displayed in the [CE Calculation Task List](7-1-ce-calculation-task-list.md). |
