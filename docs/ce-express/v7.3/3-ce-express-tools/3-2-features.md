...
| Technology | Describes the technology of the [network object](#kw:object-types:ce-express-network-objects). Possible values are 2G, 3G, 4G, and 5G. |
...
| Antenna | Define [antenna patterns](#kw:importing-antenna-patterns:ce-express-antenna) for the Cell object. |
...
| Tx Mimo | Transmitter antenna count. Available values: 1, 2, 4, 8, 16, 32 and 64. |
| Rx Mimo | Receiver antenna count. Available values: 1, 2, 4, 8, 16, 32 and 64. |
| Technology | Describes the technology of the [network object](#kw:object-types:ce-express-network-objects). |
...
| Status | Current status of the [network object](#kw:object-types:ce-express-network-objects). |
...
| Antenna | Define [antenna patterns](#kw:importing-antenna-patterns:ce-express-antenna) for the mesh node object. |
...
| Show in table | Opens the selected objects attribute table ![icon](../../../assets/images/ce-express/user-guide-v73/p047-img1.png). |
