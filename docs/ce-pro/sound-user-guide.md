...
Cellular Expert Desktop Sound for [ArcGIS Pro](#ce-pro-rcp)+platform)+Pro+Esri+desktop+software) User Guide 4.9
Table of Contents
...
5.1.3 [Clutter](#kw:clutter-classes-grid:geodata-clutter) heights 24s
5.1.4 Buildings 28
...
Cellular Expert Desktop Sound for [ArcGIS Pro](#ce-pro-rcp) User Guide 4.9
...
7.7.1 Edit Network Objects template 99
7.7.2 Manage Network Object Template 100
7.7.3 Modulations 100
7.7.4 Modulation Editor 102

## 7.8 Import Objects 104

7.8.1 Import) Cells 105
7.8.2 Import) Sites, Radar, CPE, or Repeaters 108

## 7.9 Import/Export Antenna Files 109

7.9.1 Import Antennas 109
7.9.2 Export Antennas 109
...
8.1.3 Tools 123
8.1.4 Import 127
8.1.5 Export (Profile Report) 128
8.1.6 Settings 130
9. Coverage Prediction 131
