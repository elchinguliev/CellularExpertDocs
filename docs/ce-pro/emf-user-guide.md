...
Cellular Expert Desktop [EMF](https://www.google.com/search?q=EMF+electromagnetic+field+exposure+assessment) for [ArcGIS Pro](https://www.google.com/search?q=[ArcGIS](https://www.google.com/search?q=ArcGIS+Esri+[GIS](https://www.google.com/search?q=GIS+Geographic+Information+System)+platform)+Pro+Esri+desktop+software) User Guide 4.9
Table of Contents
...
Cellular Expert Desktop [EMF](https://www.google.com/search?q=EMF+electromagnetic+field+exposure+assessment) for [ArcGIS Pro](https://www.google.com/search?q=ArcGIS+Pro+Esri+desktop+software) User Guide 4.9

## 7.2 Add Object 54

7.2.1 Add [Cell](https://www.google.com/search?q=mobile+cell+sector+coverage+base+station) 54
...
7.5.1 Preview Antenna Patterns 75
...
7.7.1 Edit [Network Objects](https://www.google.com/search?q=radio+network+objects+sites+cells+GIS) template 102
7.7.2 Manage [Network Object](https://www.google.com/search?q=radio+network+object+GIS+database) Template 103
7.7.3 Modulations 103
7.7.4 Modulation Editor 105

## 7.8 Import Objects 107

7.8.1 [Import](https://www.google.com/search?q=data+import+GIS+network+objects+[CSV](https://www.google.com/search?q=CSV+comma+separated+values+file+format)) Cells 108
7.8.2 [Import](https://www.google.com/search?q=data+import+GIS+network+objects+[CSV](https://www.google.com/search?q=CSV+comma+separated+values+file+format)) Sites, Radar, [CPE](https://www.google.com/search?q=CPE+Customer+Premises+Equipment+wireless), or Repeaters 111

## 7.9 Import/Export Antenna Files 112

7.9.1 Import Antennas 112
7.9.2 [Export](https://www.google.com/search?q=data+export+GIS+raster+vector) Antennas 112
...
9.1.3 Tools 128
9.1.4 Import 132
9.1.5 [Export](https://www.google.com/search?q=data+export+GIS+raster+vector) (Profile Report) 133
9.1.6 Settings 135
10. [Coverage Prediction](https://www.google.com/search?q=coverage+prediction+RF+radio+planning) 136
Confidential ©Cellular Expert, 2026 Page | 3

---

Cellular Expert Desktop EMF for [ArcGIS Pro](https://www.google.com/search?q=ArcGIS+Pro+Esri+desktop+software) User Guide 4.9
...
The EMF Calculation Tool analyzes and visualizes [electromagnetic field](https://www.google.com/search?q=electromagnetic+field+EMF+exposure+limits) (EMF) exposure based on various
...
Reflection factor
Reflection factor, used for the [electromagnetic field](https://www.google.com/search?q=electromagnetic+field+EMF+exposure+limits) exposure prediction calculations. Available selections:
...
EMF Calculation, Link Prediction, [Model Tuning](https://www.google.com/search?q=propagation+model+tuning+calibration+CE), Optimal Site Positions Calculation, [RF Prediction](https://www.google.com/search?q=RF+radio+frequency+prediction+coverage+planning), Siren
