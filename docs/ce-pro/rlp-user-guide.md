...
Cellular Expert Desktop RLP for [ArcGIS Pro](#ce-pro-rcp)+platform)+Pro+Esri+desktop+software) User Guide 4.9
Table of Contents
...
5.1.1 [Digital [Terrain](https+TLS+secure+protocol)://www.google.com/search?q=terrain+elevation+model+GIS+topography) Model](https+TLS+secure+protocol)://www.google.com/search?q=Digital+Terrain+topography)+Model+[DTM](#geodata-dem)+bare+earth) ([DTM](#geodata-dem)) Grid (Mandatory) 17
5.1.2 [Clutter](#kw:clutter-classes-grid:geodata-clutter) classes grid 20
5.1.3 [Clutter](#kw:clutter-classes-grid:geodata-clutter) heights 26
5.1.4 Buildings 30
6. [Workspace](#kw:creating-a-workspace:ce-express-workspace)+[workspace](#kw:creating-a-workspace:ce-express-workspace)+project+geodatabase) 34

## 6.1 Workspace Tool 34

6.1.1 Workspace+workspace+project+geodatabase) Table 34
...
Cellular Expert Desktop RLP for [ArcGIS Pro](#ce-pro-rcp) User Guide 4.9
...
11.1.1 Gaseous Absorption+oxygen+water+vapour+radio) 174
11.1.2 Temperature 175
11.1.3 [Multipath Fading](#kw:geoclimatic-data:ce-express-radio-link)+fading+radio+propagation+effect) 176
...
calculations. The default selection is LOS [ITU-R](#kw:geoclimatic-data:ce-express-radio-link) P.525 (6GHz – 100GHz) – Default.
...
Gain
Antenna gain+directional) value in dBi.
...
Noise Floor, dB
Refers to the minimum power level of unwanted noise or interference at the receiver at the base station+NodeB+eNodeB+gNodeB).
Noise Figure, dB
...
Cellular Expert Desktop RLP for ArcGIS Pro User Guide 4.9
11.1.3 [Multipath Fading](#kw:geoclimatic-data:ce-express-radio-link)
...
Thermal [Fade Margin](#ce-express-radio-link) Prediction
...
Click the button to open the Automatic Frequency Planning+interference) tool.
