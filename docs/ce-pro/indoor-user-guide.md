# CE Desktop Indoor User Guide v4.9

Cellular Expert Desktop Indoor for [ArcGIS Pro](https://www.google.com/search?q=[ArcGIS](https://www.google.com/search?q=ArcGIS+Esri+[GIS](https://www.google.com/search?q=GIS+Geographic+Information+System)+platform)+Pro+Esri+desktop+software) User Guide 4.9
Table of Contents
...
6.1.3 Create Indoor Workspace 38
6.1.4 Open Workspace 42
6.1.5 Remove Workspace 43
6.1.6 Workspace Upgrade 43
6.1.7 Workspace Properties 45

## 6.2 Docs Manager 51

## 6.3 CE Express Connection 56

6.3.1 Properties 56
7. Data Management 58
Confidential ©Cellular Expert, 2026 Page | 2

---

Cellular Expert Desktop Indoor for [ArcGIS Pro](https://www.google.com/search?q=ArcGIS+Pro+Esri+desktop+software) User Guide 4.9

## 7.1 Network Objects 58

## 7.2 Add Object 58

7.2.1 Add [Cell](https://www.google.com/search?q=mobile+cell+sector+coverage+base+station) 58

## 7.3 Object Editor 66

7.3.1 Move Objects 68
7.3.2 Duplicate Objects 72

## 7.4 Clutter Classes 75

## 7.5 Antenna Viewer 79

7.5.1 Preview Antenna Patterns 79

## 7.6 Prediction Model Manager 79

7.6.1 Models 81

## 7.7 Template Manager 104

7.7.1 Edit [Network Objects](https://www.google.com/search?q=radio+network+objects+sites+cells+GIS) template 105
7.7.2 Manage [Network Object](https://www.google.com/search?q=radio+network+object+GIS+database) Template 105
7.7.3 Modulations 106
7.7.4 Modulation Editor 108

## 7.8 Import Objects 110

7.8.1 [Import](https://www.google.com/search?q=data+import+GIS+network+objects+[CSV](https://www.google.com/search?q=CSV+comma+separated+values+file+format)) Cells 111
7.8.2 [Import](https://www.google.com/search?q=data+import+GIS+network+objects+[CSV](https://www.google.com/search?q=CSV+comma+separated+values+file+format)) Sites, Radar, [CPE](https://www.google.com/search?q=CPE+Customer+Premises+Equipment+wireless), or Repeaters 114

## 7.9 Import/Export Antenna Files 115

7.9.1 Import Antennas 115
7.9.2 [Export](https://www.google.com/search?q=data+export+GIS+raster+vector) Antennas 115
7.9.3 Create Antennas 116
8. Profile 118

## 8.1 Profile Tool 118

8.1.1 Properties 118
8.1.2 Draw Profile 122
8.1.3 Tools 129
8.1.4 Import 133
8.1.5 [Export](https://www.google.com/search?q=data+export+GIS+raster+vector) (Profile Report) 134
8.1.6 Settings 136
9. [Coverage Prediction](https://www.google.com/search?q=coverage+prediction+RF+radio+planning) 137

## 9.1 CE Calculation Task List 137
...
## 9.2 Visibility Prediction 137

10. About 141

## 10.1 License information 141

## 10.2 Help 141

10.2.1 Documentation 141
10.2.2 What’s New 142
10.2.3 Technical Support 143
10.2.4 Error log 143
11. Technical Support 144
Confidential ©Cellular Expert, 2026 Page | 4

---

Cellular Expert Desktop Indoor for ArcGIS Pro User Guide 4.9
...
button and select the building data. Formats supported: .DWG, .DXF, .SHP (line [shapefile](https://www.google.com/search?q=Shapefile+Esri+vector+GIS+format)), .PDF (raster
...
Cellular Expert Desktop Indoor for ArcGIS Pro User Guide 4.9
If line [shapefile](https://www.google.com/search?q=Shapefile+Esri+vector+GIS+format) data (.SHP format files) is selected:
...
- Optimal [Site](https://www.google.com/search?q=cell+site+tower+base+station+location) Position – results of optimal site positioning.
...
and WiFi. It is also utilized in critical networks like [TETRA](https://www.google.com/search?q=TETRA+Terrestrial+Trunked+Radio), APCO, P-25, and military applications to model
antenna coverage within a specific area.
For Mobile Operator case, if one [sector](https://www.google.com/search?q=cell+sector+antenna+coverage+area) has several carriers, as an example 3 carriers, then 3 cells
...
Cellular Expert Desktop Indoor for ArcGIS Pro User Guide 4.9
[azimuth](https://www.google.com/search?q=antenna+azimuth+direction+degrees+north) value based on defined direction on the map.
...
Value range from 0 to 1. Required for Duplex mode [TDD](https://www.google.com/search?q=TDD+Time+Division+Duplex+LTE+5G), which is applicable for 4G and 5G
Confidential ©Cellular Expert, 2026 Page | 62

---

Cellular Expert Desktop Indoor for ArcGIS Pro User Guide 4.9
technologies, and used for Downlink [Throughput](https://www.google.com/search?q=network+throughput+downlink+uplink+capacity) calculations. For example, if defined value is 0.7,
...
The Cell load affects RSSI, [RSRQ](https://www.google.com/search?q=RSRQ+Reference+Signal+Received+Quality+LTE), and DL Throughput calculations. For example, if the Cell load is
...
Duplex Mode
Available values [FDD](https://www.google.com/search?q=FDD+Frequency+Division+Duplex+LTE) or [TDD](https://www.google.com/search?q=TDD+Time+Division+Duplex+LTE+5G). Required for 4G and 5G technologies. For other technologies define
value [FDD](https://www.google.com/search?q=FDD+Frequency+Division+Duplex+LTE).
Antenna
...
different radiocommunication systems which is derived explicitly from [ITU-R](https://www.google.com/search?q=ITU+R+International+Telecommunication+Union+Radio) path loss modelling
methods as follows:
...
LOS is considered a necessary condition, e.g., for Fixed ([Point-to-Point](https://www.google.com/search?q=point+to+point+radio+link+microwave)) Links or Mobile Systems
in mmWave bands.
...
wave field strength of radio waves in the 10 kHz to 30 MHz frequency range. This [frequency band](https://www.google.com/search?q=radio+frequency+band+telecom+[spectrum](https://www.google.com/search?q=radio+frequency+spectrum+allocation+telecom))
...
Distance (d)
Field strength diminishes with increasing distance due to geometrical spreading and [absorption](https://www.google.com/search?q=atmospheric+absorption+radio+signal) by the
...
sound, and is increasingly applied in [siren](https://www.google.com/search?q=siren+audibility+sound+propagation+ISO9613) sound modeling within public security, emergency
warning systems, and defense operations. This modeling ensures that [acoustic](https://www.google.com/search?q=acoustic+propagation+sound+wave+modeling) alert systems (e.g.
...
By applying ISO 9613-2, engineers can model how far a [siren](https://www.google.com/search?q=siren+audibility+sound+propagation+ISO9613) can be heard under specific
...
empirically modeling the [scattering](https://www.google.com/search?q=radio+wave+scattering+propagation) of other rays around the receiver. It applies to all ranges of
...
from a [Digital Surface Model](https://www.google.com/search?q=Digital+Surface+Model+DSM+buildings) (DSM). Ideally, these data should be created with [LiDAR](https://www.google.com/search?q=LiDAR+light+detection+ranging) or similar
...
areas, while propagation modeling in Obstructed [Line of Sight](https://www.google.com/search?q=Line+of+Sight+LOS+radio+propagation) (OLOS) and Non-[Line of Sight](https://www.google.com/search?q=Line+of+Sight+LOS+radio+propagation)
(NLOS) areas uses empirically determined parameters defined in ITU-R and 3GPP
recommendations. It also models the [scattering](https://www.google.com/search?q=radio+wave+scattering+propagation) of other rays around the receiver. The model
...
such as soil, water, or vegetation. These interactions influence reflection, refraction, and [absorption](https://www.google.com/search?q=atmospheric+absorption+radio+signal)
...
[Fresnel zone](https://www.google.com/search?q=Fresnel+zone+radio+link+clearance+calculation). The percentage must be in the range of 1 to 200. The value can be changed either
